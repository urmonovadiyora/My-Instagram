...
import { CenterFocusStrong, CenterFocusWeak, FilterCenterFocus } from "@material-ui/icons";
          ...
          <div className="app__posts">
            {user && (
              <span>
                ...
                <center>
                  <span className="text5"><span className="text3"> 2 </span> {count} <span className="text4">0</span></span>
